...
export default function Navbar({ addStart, addDestination }: NavbarProps) {
      ...
      <div className="flex items-center mt-5 gap-x-2">
        ...
        <div className="flex-1 flex flex-col gap-y-2">  
          <APIProvider apiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY!}>
            <PlaceAutocomplete onPlaceSelect={addStart} placeholder="Choose starting point" />
            <PlaceAutocomplete onPlaceSelect={addDestination} placeholder="Choose destination" />
          </APIProvider>
        </div>
